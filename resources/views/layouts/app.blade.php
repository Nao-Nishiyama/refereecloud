        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @auth
                        {{-- This will not show up in the admin pages --}}
                        @if (!request()->is('admin/*'))
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    @can('admin')
                                        {{-- admin = key that was created in AppServiceProvider.php --}}
                    ...
                    @if (request()->is('admin/*'))
                        <div class="col-3">
                           <div class="list-group">
                            {{-- Users --}}
                            <a href="{{ route('admin.users') }}" class="list-group-item {{ request()->is('admin/users') ? 'active' : '' }} {{ request()->is('admin/search') ? 'active' : '' }}">
