...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        $uncategorized_count = 0; // this holds the number of uncategorized posts
    ...
    public function store(Request $request)
    {
        ...
        $this->category->name = ucwords(strtolower($request->name)); //uc = uppercase : first letter capitalized
        $this->category->save();
